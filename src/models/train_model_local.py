...
os.chdir('/Users/nicollegarber/Documents/GitHub/Disaster_Tweets/')
...
if __name__ == "__main__":
    ...
    # Load the data
    train_df = pd.read_csv(data_path / "raw")
    ...
    with mlflow.start_run(experiment_id=experiment_id):
        ...
        print("optimizer_name", optimizer.__class__.__name__)
        print("loss_fn_name", loss_fn.__class__.__name__)
        print("model_name", model.__class__.__name__)
        print("tokenizer_name", tokenizer.__class__.__name__)
        print("tokenizer_max_length", tokenizer.max_len)
        print(model, "model")
